...
public class Main {
    public static void main(String[] args) {
        // If you want to log information, change to 1 or 2. (running with "2" makes use() sleep longer, to print properly)
        int verbose = 0;
        ...
        Test[] tests = {
                ...
                new DeadlockCustomTest1(), // ten jeszcze fajniejszy
